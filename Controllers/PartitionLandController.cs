...
namespace ThaniyasFarmerAppAPI.Controllers
{
    ...
    public class PartitionLandController : ControllerBase
    {
        ...
        public async Task<ActionResult<PartitionLandEditViewModel>> AddpartitionLand([FromBody]PartitionLandViewModel input)
        {
            ...
            try
            {
                ...
                if (input != null)
                {
                    ...
                    partitionLandDetail.LandDetails = landDetail;
        ...
        public async Task<ActionResult<IEnumerable<PartitionLandDetail>>> GetPartLandActivity()
        {

            return await _context.PartitionLandDetails.ToListAsync();
        ...
        public async Task<ActionResult<PartitionLandEditViewModel>> GetPartLand(int id)
        {
            ...
            if (PartLand != null)
            {
                ...
                partitionLandEditViewModel.selectedLandDetailId = PartLand.LandDetails.ID;
                //return NotFound();
            }
